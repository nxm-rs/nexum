#![allow(missing_docs)]
//! Example of using the apdu_pair macro with payload field handling
...
apdu_pair! {
    ...
    pub struct GetDataSimplified {
        ...
        response {
            ...
            // Note: No custom_parse needed - the #[payload] attribute handles it automatically
...
fn main() {
    ...
    let cmd = GetDataSimplifiedCommand::serial_number();
